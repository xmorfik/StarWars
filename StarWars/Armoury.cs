...
namespace StarWarsForPoor
{
    ...
    {
        Bitmap ShipField;
        public  Bitmap HullImg = new Bitmap(@"C:img\Hull.png");
        public  Bitmap WeaponImg = new Bitmap(@"C:img\Weapon.png");
        public  Bitmap BulletImg = new Bitmap(@"C:img\Bullet1.png");
        public  Hull ChosenHull = new Hull(1, new Bitmap(@"C:img\Hull.png"), 1, 10);
        public  Weapon ChosenWeapon = new Weapon(1, new Bitmap(@"C:img\Weapon.png"), 1, new Bitmap(@"C:img\Bullet1.png"));
        ...
        public Armoury()
        {
            ...
            this.ShipField = new Bitmap(@"C:img\Space.jpg");
        }
        ...
        public void Save(string part = @"dat\")
        {
            ...
            using (FileStream fs = new FileStream($@"C:dat\hull3.xml", FileMode.OpenOrCreate))
            {
