...
namespace StarWarsForPoor
{
    public partial class ArmouryForm : Form
    {
        ...
        public ArmouryForm(SpaceWinForm sf)
        {
            InitializeComponent();
            this.sf = sf;
            h1.Save();
        ...
        {
            h1.HullImg = new Bitmap(@"C:img\Hull1n.png");
        ...
        {
            h1.HullImg = new Bitmap(@"C:img\Hull.png");
        ...
        {
            h1.HullImg = new Bitmap(@"C:img\Hull2.png");
        ...
        {
            h1.WeaponImg = new Bitmap(@"C:img\Weapon.png");
            h1.BulletImg = new Bitmap(@"C:img\Bullet1n.png");
        ...
        {
            h1.WeaponImg = new Bitmap(@"C:img\Weapon1.png");
            h1.BulletImg = new Bitmap(@"C:img\Bullet2n.png");
        ...
        {
            h1.WeaponImg = new Bitmap(@"C:img\Weapon2.1.png");
            h1.BulletImg = new Bitmap(@"C:img\Bullet3n.png");
        ...
        {
            h1.WeaponImg = new Bitmap(@"C:img\Weapon3.png");
            h1.BulletImg = new Bitmap(@"C:img\Bullet4n.png");
        ...
        {
            h1.WeaponImg = new Bitmap(@"C:img\Weapon4.png");
            h1.BulletImg = new Bitmap(@"C:img\Bullet5n.png");
        ...
        {
            int moneyErned = dat.Score / 2;
            Money += moneyErned;
            string message = " Score : " + dat.Score.ToString() + " Money earned : " + moneyErned.ToString();
