...
namespace StarWarsForPoor.Objects.InSpace.Asteroids
{
    ...
    {
        public MediumAsteroid() : base(new Bitmap(@"C:img\Asteroid2.png"),
                          new Point(RngProvider.Random.Next(0, Space.SpaceField.Width), -(new Bitmap(@"C:img\Asteroid2.png").Height)),
