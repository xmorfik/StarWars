...
namespace StarWarsForPoor.Objects.InSpace.Asteroids
{
    ...
    { 
        public EnormusAsteroid() : base(new Bitmap(@"C:img\Asteroid3.png"),
                          new Point(RngProvider.Random.Next(0, Space.SpaceField.Width), -(new Bitmap(@"C:img\Asteroid3.png").Height)),
